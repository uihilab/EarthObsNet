...
from dataPrj_SA_model import MAnet_SA
from dataPrj_SA_utils import (  
    load_checkpoint,
    save_checkpoint,
    get_loadersTrain,
...
def train_fn(loader, model, optimizer, loss_fn): 
    ...
    for batch_idx, (outInput, data, target) in enumerate(loop):
        ...
        loss1 = loss_fn[0](predictions, target)
        loss3 = loss_fn[1](predictions, target)
